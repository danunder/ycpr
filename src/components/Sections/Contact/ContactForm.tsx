  ...
  return (
    <form className="grid min-h-[320px] grid-cols-1 gap-y-4" method="POST" onSubmit={handleSendMessage}>
      ...
      <button
        ...
        className="w-max rounded-full border-2 border-orange-600 bg-indigo-400 px-4 py-2 text-sm font-medium text-black shadow-md outline-none hover:bg-stone-800 focus:ring-2 focus:ring-orange-600 focus:ring-offset-2 focus:ring-offset-stone-800"
        type="submit">
        Send Message
      </button>
    </form>
